...
<tr>
  ...
  <td><a target="blank" href="view_profile.php?f_id=<?php echo $row3['f_id'];?>&j_id=<?php echo $j_id;?>"><i class="fa fa-eye"></i></a></td>
  <td><a href="shortlist.php?f_id=<?php echo $row3['f_id'];?>&j_id=<?php echo $j_id;?>" onclick="return confirm('Do you want to delete this record ?')"><i class="fa fa-check"></i></a></td>
  <td><a href="reject.php?f_id=<?php echo $row3['f_id'];?>&j_id=<?php echo $j_id;?>" onclick="return confirm('Do you want to delete this record ?')"><i class="fa fa-trash-o"></i></a></td>
</tr>
...
<table border="1" bordercolor="#fff" cellspacing="0">
<p style="float: left;color: white;font-weight: bold;font-size: 140%;">Shortlisted</p>
<tr> 
  <th>S No.</th>
  <th>Name</th>
  <th>Email ID</th>
...
<?php
$count=1;
$sql2="SELECT * FROM shortlist WHERE j_id='$j_id'";
$result2=mysqli_query($conn,$sql2);
if ($result2->num_rows > 0) {
while($row2 = $result2->fetch_assoc()) {
...
<tr style="background: #27ae60;">
  ...
  <td><?php echo $row3['f_age'];?></td>
  <td><a target="blank" href="view_profile.php?f_id=<?php echo $row3['f_id'];?>&j_id=<?php echo $j_id;?>"><i class="fa fa-eye"></i></a></td>
  <td><a href="undo.php?f_id=<?php echo $row3['f_id'];?>&j_id=<?php echo $j_id;?>&col=<?php echo "short";?>" onclick="return confirm('Do you want to delete this record ?')"><i class="fa fa-undo"></i></a></td>
</tr>
...
<table border="1" bordercolor="#fff" cellspacing="0">
<p style="float: left;color: white;font-weight: bold;font-size: 140%;">Rejected</p>
<tr> 
  <th>S No.</th>
  <th>Name</th>
  <th>Email ID</th>
...
<?php
$count=1;
$sql2="SELECT * FROM reject WHERE j_id='$j_id'";
$result2=mysqli_query($conn,$sql2);
if ($result2->num_rows > 0) {
while($row2 = $result2->fetch_assoc()) {
...
<tr style="background: #c0392b;">
  ...
  <td><?php echo $row3['f_age'];?></td>
  <td><a target="blank" href="view_profile.php?f_id=<?php echo $row3['f_id'];?>&j_id=<?php echo $j_id;?>"><i class="fa fa-eye"></i></a></td>
  <td><a href="undo.php?f_id=<?php echo $row3['f_id'];?>&j_id=<?php echo $j_id;?>&col=<?php echo "rej";?>" onclick="return confirm('Do you want to delete this record ?')"><i class="fa fa-undo"></i></a></td>
</tr>
